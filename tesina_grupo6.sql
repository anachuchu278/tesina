...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-06-2024 a las 12:54:21
...
INSERT INTO `det_pago` (`id`, `id_pago`, `monto`, `id_metodop`) VALUES
(1, 1, 5000, 4);
...
INSERT INTO `horario_medico` (`id`, `dia_sem`, `hora_inicio`, `hora_final`, `id_usuario`) VALUES
...
INSERT INTO `pago` (`id`, `fecha_pago`) VALUES
...
--
ALTER TABLE `det_pago`
  ADD CONSTRAINT `det_pago_ibfk_1` FOREIGN KEY (`id_pago`) REFERENCES `pago` (`id`),
  ADD CONSTRAINT `det_pago_ibfk_2` FOREIGN KEY (`id_metodop`) REFERENCES `met_pago` (`id`);
...
--
ALTER TABLE `turno`
  ADD CONSTRAINT `turno_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id`),
  ADD CONSTRAINT `turno_ibfk_2` FOREIGN KEY (`id_paciente`) REFERENCES `paciente` (`id_Paciente`),
  ADD CONSTRAINT `turno_ibfk_3` FOREIGN KEY (`id_pago`) REFERENCES `pago` (`id`),
